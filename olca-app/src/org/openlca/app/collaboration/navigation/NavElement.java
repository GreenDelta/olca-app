...
record NavElement(ElementType type, Object content, boolean isFromDataPackage, List<NavElement> children) {
	...
	NavElement(Descriptor d) {
		this(ElementType.MODEL, d, !Strings.nullOrEmpty(d.dataPackage), new ArrayList<>());
	}
