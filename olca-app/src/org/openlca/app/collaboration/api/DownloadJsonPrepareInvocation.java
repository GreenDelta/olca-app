...
class DownloadJsonPrepareInvocation extends Invocation<String, String> {
	...
	private final Collection<? extends TypeRefIdPair> requestData;

	DownloadJsonPrepareInvocation(String repositoryId, Collection<? extends TypeRefIdPair> requestData) {
