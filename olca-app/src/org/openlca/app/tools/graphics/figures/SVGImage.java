...
public class SVGImage extends ImageFigure {
	...
	private class RenderingListenerImpl
		...
		public void paintFigureWhileRendering(Graphics g) {
			SVGImage.this.paintFigureWhileRendering(g);
		}

		@Override
		public void imageRendered(RenderedImage rndImg) {
			if (SVGImage.this.getParent() != null) {
				SVGImage.this.setRenderedImage(rndImg);
	...
	public SVGImage(RenderedImage renderedImage) {
	 ...
	 *            the image.
	 */
	public SVGImage(RenderedImage renderedImage, boolean antiAlias) {
