...
public class OpenMiniatureViewAction extends Action {
	...
	public OpenMiniatureViewAction(SankeyEditor editor) {
	...
	@Override
	public void run() {
		MiniView view = new MiniView(UI.shell(), editor);
		view.open();
	}
	...
	private static class MiniView extends ApplicationWindow {
		...
		private final RootEditPart part;

		public MiniView(Shell shell, SankeyEditor editor) {
			super(shell);
			viewer = (GraphicalViewer) editor.getAdapter(GraphicalViewer.class);
			part = editor.getRootEditPart();
		}
