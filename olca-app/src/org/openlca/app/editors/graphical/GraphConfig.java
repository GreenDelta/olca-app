...
public class GraphConfig implements Copyable<GraphConfig> {
	...
	public boolean isProcessEditingEnable = false;
	...
	public void copyTo(GraphConfig other) {
		...
		other.isProcessEditingEnable = isProcessEditingEnable;
		other.theme = theme;
	...
	public GraphConfig copy() {
		...
		clone.isProcessEditingEnable = isProcessEditingEnable;
		clone.theme = theme;
	...
	public static GraphConfig fromJson(JsonObject obj) {
		...
		config.isRouted = Json.getBool(
				obj, "isRouted", true);
		config.isProcessEditingEnable = Json.getBool(
			obj, "editMode", false);
	...
	public JsonObject toJson() {
		...
		obj.addProperty("isProcessEditingEnable", isProcessEditingEnable);
