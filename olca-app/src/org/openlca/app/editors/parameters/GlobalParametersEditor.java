...
public class GlobalParametersEditor extends FormEditor implements IEditor {
	...
	public static void open() {
		...
		GlobalParametersInput input = new GlobalParametersInput();
	...
	private class Page extends FormPage {
		...
		public Page() {
			super(GlobalParametersEditor.this, "GlobalParameterEditor.Page",
		...
		protected void createFormContent(IManagedForm managedForm) {
			...
			ParameterSection
					.forInputParameters(GlobalParametersEditor.this,
							support, sash, toolkit)
					.setSupplier(supplier, ParameterScope.GLOBAL);
			ParameterSection
					.forDependentParameters(GlobalParametersEditor.this,
							support, sash, toolkit)
					.setSupplier(supplier, ParameterScope.GLOBAL);
		}
	}
