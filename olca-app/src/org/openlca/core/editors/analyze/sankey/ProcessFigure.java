...
/**
 * The figure of a process in the Sankey diagram.
 */
public class ProcessFigure extends Figure {
	...
	private void drawTexts(Graphics g, String single, String total) {
		...
		g.drawText(Messages.Analyze_SingleAmount + ":", loc.x + 5, loc.y + 35);
		g.drawText(single, loc.x + 5, loc.y + 50);
		g.drawText(Messages.Analyze_TotalAmount + ":", loc.x + 5, loc.y + 80);
