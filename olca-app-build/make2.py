...
def pack_macos(version_date):
    ...
    shutil.copyfile('templates/Info.plist', base + 'openLCA.app/Contents/Info.plist')
    ...
    shutil.copy2(base+"MacOS/openLCA", base +
    ...
    os.remove(base + "openLCA.app/Contents/MacOS/openLCA.ini")
