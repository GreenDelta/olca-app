 ...
 * 
 */
public class MaximizeAllProcessesAction extends Action {

	/**
	 * ID of this Action
	 */
	public static final String ID = "org.openlca.core.editors.productsystem.graphical.actions.MaximizeAllProcessesAction";
	...
	public ImageDescriptor getImageDescriptor() {
		return ImageType.MAXIMIZE_ICON.getDescriptor();
	}

	@Override
	public String getText() {
		return Messages.Systems_MaximizeAllProcessesAction_Text;
	}
			...
			if (node instanceof ProcessNode) {
				...
				if (processNode.isMinimized()) {
					...
					if (actualCommand == null) {
						actualCommand = new MaximizeCommand(processNode);
					} else {
						actualCommand = actualCommand
								.chain(new MaximizeCommand(processNode));
					}
				}
			}
		}
